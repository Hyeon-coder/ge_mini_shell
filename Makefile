...
SRC = \
	...
	$(SRC_DIR)$(UTL_DIR)error_utils.c $(SRC_DIR)$(UTL_DIR)shlvl.c $(SRC_DIR)$(UTL_DIR)utils.c \
	$(SRC_DIR)$(UTL_DIR)prompt.c $(SRC_DIR)$(UTL_DIR)free.c $(SRC_DIR)$(UTL_DIR)free_utils.c \
	...
	$(SRC_DIR)$(EXEC_DIR)executor_utils.c $(SRC_DIR)$(EXEC_DIR)heredoc_utils.c \
	$(SRC_DIR)$(EXEC_DIR)redirection_utils.c \
	...
	$(SRC_DIR)$(BLT_DIR)pwd.c $(SRC_DIR)$(BLT_DIR)unset.c
